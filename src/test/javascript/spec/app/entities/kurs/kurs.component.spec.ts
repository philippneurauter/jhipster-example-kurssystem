...
import { KursComponent } from 'app/entities/kurs/kurs.component';
import { KursService } from 'app/entities/kurs/kurs.service';
import { Kurs } from 'app/shared/model/kurs.model';

describe('Component Tests', () => {
    describe('Kurs Management Component', () => {
        let comp: KursComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(KursComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.kurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
